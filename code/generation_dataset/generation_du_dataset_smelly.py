...
# df['call_methode'] = 'false'
# df['call_external_methode'] = 'false'
#
# print(df.head(3))
# columnsTitles = ['number_of_callers_not_null', 'is_init','is_static','is_override','uses_variables','call_methode','call_external_methode', 'full_name']
#
# df = df.reindex(columns=columnsTitles)
# print(df.head(3))
...
df['call_external_method'] = 'false'
df.rename(columns={'name': 'full_name'},inplace=True)
print(df.head(3))
columnsTitles = ['is_static','is_enum','uses_variables','call_method','is_interface','is_local_class','call_external_method','full_name']
