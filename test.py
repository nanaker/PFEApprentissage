...
##MIM
datasetpath=["dataset/MIM/taken/MIM_AllKNN.csv","dataset/MIM/taken/MIM_InstanceHardnessThreshold.csv"]
...
result.to_csv('dataset/MIM/MIM_train_result3.csv', index=False)
